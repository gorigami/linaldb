...
mod tests {
    ...
    fn comments_are_skipped() {
        assert_eq!(tok("LET -- this is a comment\nx = ADD a b"),
                   tok("LET x = ADD a b"));
        assert_eq!(tok("# hash comment\nLET x = ADD a b"),
                   tok("LET x = ADD a b"));
    }
